-----------------------------
Name: Sai Manish Sasanapuri

Roll number: IMT2018520
-----------------------------

About code :

Base Model of Tomasulo machine, It is single memory access and using only R-format minstructions from RISC-V ISA, for this assignment.
...
- > Output of the code is in this folder - Output.png